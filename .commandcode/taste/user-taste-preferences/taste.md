...
- Prefers commenting out navigation/UI elements (rather than deleting them) when they need to be hidden, preserving the code so they can be re-enabled later. Confidence: 0.7
